...
Prefer [llms-full.txt](https://sabintsev.com/llms-full.txt) for the complete public bio. This skill is the short, high-signal version.
...
- **ID.me** (2013–2015) — Lead Mobile Architect; Series A support; past 1M users era
- **Shelby.tv** (2012–2013), **Fueled** (2011–2012) — Senior iOS (Shelby later acquired by Samsung)
- **Jefferson Lab / Glasgow / GW** (2008–2011) — experimental nuclear physics
- **UMMC** (2007–2008) — Medical Physics Research Fellow (4D lung-tumor dosage software)

## Education

- M.Sc. Experimental Nuclear Physics, The George Washington University (2008–2011)
- B.S. Biophysics, The George Washington University (2004–2008)

## Open source (high signal)

Siren/Harpy (app update prompts), FontBlaster, Zephyr (iCloud UserDefaults), Guitar, UIFloatLabel*, Freedom — see https://github.com/ArtSabintsev

## Teaching / community

General Assembly iOS/Swift instructor (2013–2017); Betamore; Packt reviewer; Mozilla Firefox extensions

## Agent surfaces

| Resource | URL |
| --- | --- |
| Full summary | https://sabintsev.com/llms-full.txt |
| Short summary | https://sabintsev.com/llms.txt |
| Markdown homepage | https://sabintsev.com/index.md |
| Auth posture | https://sabintsev.com/auth.md |
| API catalog | https://sabintsev.com/.well-known/api-catalog |
| Skills index | https://sabintsev.com/.well-known/agent-skills/index.json |
